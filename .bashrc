...
alias gca='g ca'
alias gst='g s'
alias gr='ge ri' # rebase
alias grb='ge ri' # rebase
alias grc='ge rbc' # rebase continue
...
alias IntelSyncLocalFiles='slf CsisBuild.intel.com; slf CsisBuild-dr.intel.com'
